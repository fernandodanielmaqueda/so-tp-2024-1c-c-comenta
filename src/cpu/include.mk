...
BINARY_PREFIXES+=$(program1)_BIN
$(program1)_BINDIR:=$(MKFWK_LAST_INCLUDING_DIR)bin/

# Space-separated basenames of the programs to be made and placed into $(program1)_BIN
$(program1)_BIN_PROGRAMS+=$(program1)
...
$(program1)_CWD:=$(MKFWK_LAST_INCLUDING_DIR)
...
$(program1)_SRCDIR:=$(MKFWK_LAST_INCLUDING_DIR)src/
...
$(program1)_SOURCES+=$($(library1)_BINDIR)libutils.a
#   Sets the program's linking order. You may add the -l and -L linking flags here
$(program1)_LDADD:=$($(program1)_SOURCES) -lutils -lcommons -lpthread -lreadline -lm
...
# Adds the prerequired library's -I'dir' options
$(program1)_CPPFLAGS+=$($(library1)_FIND_-I_FLAGS)
...
$(program1)_LDFLAGS+=-L'$(if $($(library1)_BINDIR),$($(library1)_BINDIR),.)'
